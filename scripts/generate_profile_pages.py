    ...
    <div class="profile-page">
      ...
      <div style="margin: 40px 0; padding: 32px; background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius-lg);">
        ...
        <div style="display: flex; flex-direction: column; gap: 16px;">
          <a href="{url}" target="_blank" rel="{rel_attr}" class="btn btn-primary" style="display: inline-flex; align-items: center; gap: 8px; color: #000000; font-weight: 700; background: #8b9cff;">
      ...
      <div id="postsSection" style="margin: 40px 0; padding: 32px; background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius-lg);">
        ...
        <button id="loadMoreBtn" style="display: none; margin-top: 24px; padding: 12px 24px; background: #8b9cff; color: #000000; border: none; border-radius: var(--radius); font-size: 16px; font-weight: 700; cursor: pointer; width: 100%; transition: all 0.2s ease;" onmouseover="this.style.background='#9badff'; this.style.transform='translateY(-1px)'; this.style.boxShadow='0 4px 16px rgba(0, 0, 0, 0.4)';" onmouseout="this.style.background='#8b9cff'; this.style.transform=''; this.style.boxShadow='';" onclick="loadMorePosts()">
          Arată mai multe
        </button>
      </div>
