  ...
  <main class="container">
    <div class="profile-page">
      ...
      <div id="postsSection" style="margin: 40px 0; padding: 32px; background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius-lg);">
        ...
        <button id="loadMoreBtn" style="display: none; margin-top: 24px; padding: 12px 24px; background: var(--accent); color: #ffffff; border: none; border-radius: var(--radius); font-size: 16px; font-weight: 700; cursor: pointer; width: 100%; transition: all 0.2s ease;" onmouseover="this.style.background='var(--accent-hover)'; this.style.transform='translateY(-1px)'; this.style.boxShadow='0 4px 16px rgba(0, 0, 0, 0.4)';" onmouseout="this.style.background='var(--accent)'; this.style.transform=''; this.style.boxShadow='';" onclick="loadMorePosts()">
          Arată mai multe
        </button>
      </div>
