...
def main():
    ...
    for profile in profiles:
        ...
        if avatar:
            avatar_html = f'<img src="{html.escape(avatar)}" alt="{display_name}" width="120" height="120" loading="eager" decoding="async" style="width:100%;height:100%;object-fit:cover;border-radius:var(--radius-lg);" onerror="this.style.display=\'none\'; this.nextElementSibling.style.display=\'flex\';">\n          <span style="display:none;">{display_name[0].upper() if display_name else "?"}</span>'
        else:
